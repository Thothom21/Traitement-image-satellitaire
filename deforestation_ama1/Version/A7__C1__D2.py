...
#traitement depuis les images de base
...
#Fonction pour le canny avec dilation et érosion
# Fonction pour détecter les contours blancs et remplir les zones après une érosion et une dilatation plus douces
...
if __name__ == "__main__":
    ...
    ######
    #Partie traitement image de base avec les couleurs 
    ...
    #DILATION et érosion pour tout les image medium canny qui sont pour le meilleur rendu
    ...
    for dossier, sous_dossiers, fichiers in os.walk(repertoire_racine):
        for fichier in fichiers:
            if fichier == 'medium_canny.png':
                ...
                print(f"Contours détectés, fermés et remplis pour {chemin_image}")
